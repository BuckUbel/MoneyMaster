...
export interface IStatisticsNavigationProps {
...
export default class StatisticsNavigation extends React.Component<IStatisticsNavigationProps, {}> {

    constructor(props: IStatisticsNavigationProps) {
        super(props);
    }
                    ...
                    <Grid item xs={12} container justify={"space-between"} alignItems={"center"} spacing={8}>
                        ...
                        <Grid item lg={5} sm={7} container justify={"space-between"} spacing={8}>
                            <Grid item xs={12} md={4}>
                                <Button onClick={resetNavigation} size={"medium"} variant={"outlined"}
                                        color={"secondary"}>
                                    <p>Zurücksetzen</p>
                                </Button>
                            </Grid>
